...
const unsigned long LIGHT_PUB_MS = 50;     
std_msgs::Int16 light_msg;


const int IR_PIN = 13;                     // IR receiver Signal/Output 在 D13
...
float sampleIrRatioMicros(unsigned long window_us){
  ...
  return (float)t_low / (float)total;  
}

float ir_ema = 0.0f;                 
const float IR_EMA_ALPHA = 0.6f;    
const unsigned long IR_ONE_WINDOW_US = 15000; 
const int IR_MULTI_N = 3;                       
